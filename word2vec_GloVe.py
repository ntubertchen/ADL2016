...
class GloVeModel():
    def __init__(self, embedding_size, context_size, max_vocab_size=60000, min_occurrences=5,
                 scaling_factor=3.0/4.0, cooccurrence_cap=100, batch_size=256, learning_rate=0.1):
...
def main(_):
    import word2vec_GloVe
    model = word2vec_GloVe.GloVeModel(embedding_size=128, context_size=10)
    filename = sys.argv[1]
